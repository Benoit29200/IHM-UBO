...
public class TwitupConsultAnUserAccount extends JPanel implements IObservableConsultAccountUser {
	...
	public TwitupConsultAnUserAccount(User theUser, User userConnected, IObserverConsultAccountUser observer) {
		...
		this.add(setPanelAccount(),new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER,
	...
	private JPanel setPanelAccount() {
		...
		panelResearchTwit.add(avatar,new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panelResearchTwit.add(this.setLabelPanel(),new GridBagConstraints(0, 1, 1, 1, 1, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panelResearchTwit.add(this.setTextFieldPanel(),new GridBagConstraints(0, 2, 1, 1, 1, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panelResearchTwit.add(connectToThisAccount,new GridBagConstraints(0, 3, 1, 1, 1, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panelResearchTwit.setBorder(new LineBorder(Color.white,4));
	...
	private JPanel setLabelPanel() {
		...
		panelLabelUserAccount.add(nomLabel,new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panelLabelUserAccount.add(nom,new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
	...
	private JPanel setTextFieldPanel() {
		...
		panelTextFieldUserAccount.add(pseudoLabel,new GridBagConstraints(0,0, 1, 1, 1, 1, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panelTextFieldUserAccount.add(pseudo,new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
