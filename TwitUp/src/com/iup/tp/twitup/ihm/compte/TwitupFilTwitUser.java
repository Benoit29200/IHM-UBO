...
import com.iup.tp.twitup.ihm.twit.TwitupTwit;

public class TwitupFilTwitUser extends JPanel implements IObservableTwitupFilTwit {
	...
	public TwitupFilTwitUser(IObserverTwitupFilTwit observer,User user) {
		this.theUser = user;
